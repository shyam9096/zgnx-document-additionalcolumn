...
import styles from "./ZgnxDocument.module.scss";
import { IZgnxDocumentAdditionalcolumnProps } from "./IZgnxDocumentAdditionalcolumnProps";
...
interface IZgnxDocumentAdditionalcolumnState {
  listData: any;
  SubFolderName: any;
  SubFolderList: any;
  subFolders: any;
...
export default class ZgnxDocumentAdditionalcolumn extends React.Component<
  IZgnxDocumentAdditionalcolumnProps,
  IZgnxDocumentAdditionalcolumnState
> {
  ...
  public render(): React.ReactElement<IZgnxDocumentAdditionalcolumnProps> {
    return (
                            ...
                            return (
                              <div className={styles.row}>
                                <div>
                                 ...
                                 <div>
                                 {item.ListItemAllFields.FileDescription}
                                </div>

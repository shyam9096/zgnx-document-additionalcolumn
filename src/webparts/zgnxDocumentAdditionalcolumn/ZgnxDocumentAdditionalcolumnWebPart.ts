...
import * as strings from "ZgnxDocumentAdditionalcolumnWebPartStrings";
import ZgnxDocumentAdditionalcolumn from "./components/ZgnxDocumentAdditionalcolumn";
import { IZgnxDocumentAdditionalcolumnProps } from "./components/IZgnxDocumentAdditionalcolumnProps";
import spservices from "../../Service/spservices";

export interface IZgnxDocumentAdditionalcolumnWebPartProps {
  description: string;
  context: any;
  list: any;
  multiSelect: any;
...
export default class ZgnxDocumentAdditionalcolumnWebPart extends BaseClientSideWebPart<IZgnxDocumentAdditionalcolumnWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IZgnxDocumentAdditionalcolumnProps> =
      React.createElement(ZgnxDocumentAdditionalcolumn, {
